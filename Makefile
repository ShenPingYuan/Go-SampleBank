...
#	migrate -database "sqlserver://sa:1230@localhost:1433?database=simple_bank&sslmode=disable" -path db/migration -verbose up
	migrate -database "mysql://root:1230@tcp(localhost:3306)/simple_bank?charset=utf8&parseTime=True&loc=Local" -path db/migration -verbose up

drop-migrate:
#	migrate -database "sqlserver://sa:1230@localhost:1433?database=simple_bank&sslmode=disable" -path db/migration -verbose down
	migrate -database "mysql://root:1230@tcp(localhost:3306)/simple_bank?charset=utf8&parseTime=True&loc=Local" -path db/migration -verbose down
force:
#	migrate -database "sqlserver://sa:1230@localhost:1433?database=simple_bank&sslmode=disable" -path db/migration force 1
	migrate -database "mysql://root:1230@tcp(localhost:3306)/simple_bank?charset=utf8&parseTime=True&loc=Local" -path db/migration force 1
create-migrate:
