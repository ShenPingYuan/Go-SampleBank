...
// Source: github.com/ShenPingYuan/go-webdemo/db/sqlc (interfaces: Store)
...
func (m *MockStore) DeleteEntry(arg0 context.Context, arg1 int64) (sql.Result, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) GetSessionByToken(arg0 context.Context, arg1 string) (db.Session, error) {
	m.ctrl.T.Helper()
...
func (mr *MockStoreMockRecorder) GetSessionByToken(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockStore) UpdateAccountBalance(arg0 context.Context, arg1 db.UpdateAccountBalanceParams) (sql.Result, error) {
	m.ctrl.T.Helper()
